    ...
    <div class="help-body">
        ...
        <section class="help-section" id="help-customers">
            ...
            <ol class="help-steps">
                ...
                <li>Choose the first login: <strong>Email a password-setup link</strong> (they pick their own password — this sends a real email) or <strong>Set a temporary password now</strong> (shown exactly once — copy it before leaving the page; they must replace it on first login).</li>
            ...
            <div class="help-note">
                ...
                <div><strong>Suspending</strong> a customer blocks their sign-in immediately. You cannot suspend or demote your own admin account — the instance always keeps at least one administrator.</div>
            </div>
        </section>
        ...
        <section class="help-section" id="help-plans">
            ...
            <p>Plans are deactivated rather than deleted, because customer accounts reference them.</p>
        ...
        <section class="help-section" id="help-payments">
            ...
            <?php adminHelpFigure('admin-payments.png',
                ...
                'The payments ledger. <a href="' . APP_URL . '/admin/payments.php">Open payments</a>'); ?>
        </section>
        ...
        <section class="help-section" id="help-leads">
            ...
            <ol class="help-steps">
                <li>Search by category, location, radius and minimum rating to pull businesses from the map provider.</li>
                <li>Save promising results to the list; filter by the saved-leads filters and export them to CSV.</li>
            </ol>
            <div class="help-note">
                <i class="bi bi-exclamation-triangle"></i>
                <div>Each search <strong>spends credits on the configured search API</strong> — results are real and billed, so search deliberately.</div>
            </div>
        ...
        <section class="help-section" id="help-settings">
            ...
            <ol class="help-steps">
                ...
                <li>Click <strong>Save settings</strong> for those. <strong>Lead search</strong> is separate — it has its own <strong>Save lead settings</strong>, and <strong>Test key</strong> spends one SerpApi credit.</li>
            </ol>
        ...
        <section class="help-section" id="help-branding">
            ...
            <p>
                ...
                and the stock branding is replaced everywhere.
            </p>
        ...
        <section class="help-section" id="help-llm">
            ...
            <ol class="help-steps">
                ...
                <li>Add a provider with its API key and base URL if needed, then <strong>test</strong> it — the test makes a real API call that may use a little of the provider's balance, and a failed test means no customer bot can reply on it.</li>
                <li>Add models, then set <strong>Model access by plan</strong> to control which plans may use each one.</li>
            </ol>
            <p>Provider keys are stored encrypted and are never shown again after saving.</p>
            <?php adminHelpFigure('admin-llm.png',
                'AI and models page with provider configuration and model list. (redacted example)',
                'Providers, keys and the models tenants can pick. <a href="' . APP_URL . '/admin/llm.php">Open AI &amp; models</a>'); ?>
        </section>
